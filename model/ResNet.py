...
class ResNetBlock(nn.Module):
    def __init__(self, c_in, act_fn, subsample=False, c_out=-1):
        ...
        self.downsample = nn.Conv2d(c_in, c_out, kernel_size=1, strid=2) if subsample else None
        self.act_fn = act_fn()
    ...
    def _init_params(self):
        ...
        for m in self.modules:
            if isinstance(m, nn.Conv2d):
                nn.init.kaiming_normal_(m.weightk, mode='fan_out', nonlinearity=self.hparams.act_fn_name)
